        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedSide = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    CharacterName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    ...
                    LastWorkTime = table.Column<DateTime>(type: "TEXT", nullable: false),
                    LastRestTime = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChallengerUserId = table.Column<long>(type: "INTEGER", nullable: false),
                    OpponentUserId = table.Column<long>(type: "INTEGER", nullable: false),
                    ChallengerName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    OpponentName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ...
                    ChallengerChoiceAuto = table.Column<bool>(type: "INTEGER", nullable: false),
                    OpponentChoiceAuto = table.Column<bool>(type: "INTEGER", nullable: false),
